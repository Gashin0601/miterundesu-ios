...
class LocalizationManager: ObservableObject {
    ...
    private let japaneseStrings: [String: String] = [
        ...
        "whats_new_feature_quick_launch_title": "クイック起動",
        "whats_new_feature_quick_launch_desc": "ロック画面ウィジェット、コントロールセンター（iOS 18以降）、Siri・ショートカットから「ミテルンデス」をワンタップまたは音声で起動できます。",
        "whats_new_lockscreen_title": "ロック画面ウィジェットの追加方法",
        "whats_new_lockscreen_step1": "ロック画面を長押しして「カスタマイズ」をタップ",
        "whats_new_lockscreen_step2": "「ウィジェットを追加」から「ミテルンデス」を選択",
        "whats_new_lockscreen_step3": "完了をタップして保存",
        "whats_new_controlcenter_title": "コントロールセンターへの追加方法（iOS 18以降）",
        "whats_new_controlcenter_step1": "コントロールセンターを開き、左上の「＋」をタップ",
        "whats_new_controlcenter_step2": "「コントロールを追加」から「ミテルンデス」を検索",
        "whats_new_controlcenter_step3": "タップして追加し、画面外をタップして完了",
        "whats_new_shortcut_title": "Siri・ショートカットから起動",
        "whats_new_shortcut_step1": "Siriに「ミテルンデスを開く」と話しかける",
        "whats_new_shortcut_step2": "ショートカットAppで「ミテルンデスを開く」を選び、ホーム画面やオートメーションに追加",
        "whats_new_shortcut_step3": "背面タップや音量ボタンなど、お好みのトリガーに割り当て可能",
    ...
    private let englishStrings: [String: String] = [
        ...
        "whats_new_feature_quick_launch_title": "Quick Launch",
        "whats_new_feature_quick_launch_desc": "Launch Miterundesu in one tap — or just by voice — from your Lock Screen widget, Control Center (iOS 18+), Siri, or the Shortcuts app.",
        "whats_new_lockscreen_title": "How to Add Lock Screen Widget",
        "whats_new_lockscreen_step1": "Long-press the Lock Screen and tap \"Customize\"",
        "whats_new_lockscreen_step2": "Tap \"Add Widgets\" and select \"Miterundesu\"",
        "whats_new_lockscreen_step3": "Tap Done to save",
        "whats_new_controlcenter_title": "How to Add to Control Center (iOS 18+)",
        "whats_new_controlcenter_step1": "Open Control Center and tap \"+\" in the top left",
        "whats_new_controlcenter_step2": "Search for \"Miterundesu\" in \"Add a Control\"",
        "whats_new_controlcenter_step3": "Tap to add, then tap outside to finish",
        "whats_new_shortcut_title": "Launch with Siri & Shortcuts",
        "whats_new_shortcut_step1": "Say \"Open Miterundesu\" to Siri",
        "whats_new_shortcut_step2": "In the Shortcuts app, pick \"Open Miterundesu\" and add it to your Home Screen or Automations",
        "whats_new_shortcut_step3": "Assign it to Back Tap, a volume button, or any trigger you like",
